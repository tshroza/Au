...
exports.config = {
  ...
  capabilities: {
    browserName: 'chrome',
    chromeOptions: { 
        args: ['--disable-gpu', '--window-size=1600x1200'],
  ...
  // Suites
  suites: {
    'expenses': 'expenses/overview.feature', // ng e2e --suite=expenses
    'expense': 'expenses/expense/expense.feature', // ng e2e --suite=expense
